...
func (_m *Backend) GetLayer(ctx context.Context, name string) (*data.Definition, error) {
	ret := _m.Called(ctx, name)

	var r0 *data.Definition
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*data.Definition, error)); ok {
		return rf(ctx, name)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *data.Definition); ok {
		r0 = rf(ctx, name)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*data.Definition)
		}
	}
...
func (_c *Backend_GetLayer_Call) Return(_a0 *data.Definition, _a1 error) *Backend_GetLayer_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Backend_GetLayer_Call) RunAndReturn(run func(context.Context, string) (*data.Definition, error)) *Backend_GetLayer_Call {
	_c.Call.Return(run)
	return _c
}

// ListLayers provides a mock function with given fields: ctx
func (_m *Backend) ListLayers(ctx context.Context) ([]*data.Definition, error) {
	ret := _m.Called(ctx)

	var r0 []*data.Definition
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) ([]*data.Definition, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) []*data.Definition); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*data.Definition)
...
func (_c *Backend_ListLayers_Call) Return(_a0 []*data.Definition, _a1 error) *Backend_ListLayers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Backend_ListLayers_Call) RunAndReturn(run func(context.Context) ([]*data.Definition, error)) *Backend_ListLayers_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Backend) ResolveDependencies(ctx context.Context, layer *data.Definition) ([]*data.Definition, error) {
	ret := _m.Called(ctx, layer)

	var r0 []*data.Definition
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *data.Definition) ([]*data.Definition, error)); ok {
		return rf(ctx, layer)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *data.Definition) []*data.Definition); ok {
		r0 = rf(ctx, layer)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*data.Definition)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *data.Definition) error); ok {
		r1 = rf(ctx, layer)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Backend_ResolveDependencies_Call) Run(run func(ctx context.Context, layer *data.Definition)) *Backend_ResolveDependencies_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*data.Definition))
	})
	return _c
}

func (_c *Backend_ResolveDependencies_Call) Return(_a0 []*data.Definition, _a1 error) *Backend_ResolveDependencies_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Backend_ResolveDependencies_Call) RunAndReturn(run func(context.Context, *data.Definition) ([]*data.Definition, error)) *Backend_ResolveDependencies_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateLayers provides a mock function with given fields: ctx, _a1
func (_m *Backend) UpdateLayers(ctx context.Context, _a1 []*data.Definition) error {
...
func (_c *Backend_UpdateLayers_Call) Run(run func(ctx context.Context, _a1 []*data.Definition)) *Backend_UpdateLayers_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]*data.Definition))
	})
	return _c
...
func (_c *Backend_UpdateLayers_Call) RunAndReturn(run func(context.Context, []*data.Definition) error) *Backend_UpdateLayers_Call {
	_c.Call.Return(run)
	return _c
}
