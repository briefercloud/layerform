...
func TestInMemoryBackend_ResolveDependencies(t *testing.T) {
	...
	t.Run("single dependency", func(t *testing.T) {
		dependencies, err := stateBackend.ResolveDependencies(layer1)
		require.NoError(t, err)
